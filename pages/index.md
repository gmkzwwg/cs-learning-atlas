...
关于数据的研究的重要性正在随着人工智能的发展不断上升，现代 AI 很大程度上依赖数据的规模、质量、结构和处理方式；数据库、数据工程、信息检索、数据清洗、数据标注、数据治理、表示学习等内容，也因此变得越来越重要。不过从学习计算机科学的角度看，数据更像是贯穿多个方向的核心对象。
...
**Q3：学习时可以用 AI 工具吗？大量使用 AI 是否会妨碍掌握知识？**
