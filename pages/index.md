...
* [How long does it take to study computer science seriously?]({{ '/introduction/1.1.qa/#q5' | relative_url }})
* [What is this guide, and who is it for?]({{ '/introduction/1.1.qa/#q6' | relative_url }})
* [What does computer science include?]({{ '/introduction/1.1.qa/#q9' | relative_url }})
* [What is the relationship between programming and computer science?]({{ '/introduction/1.1.qa/#q10' | relative_url }})
* [How long is the shelf life of computer science knowledge?]({{ '/introduction/1.1.qa/#q12' | relative_url }})
* [Is learning computer science really difficult?]({{ '/introduction/1.1.qa/#q14' | relative_url }})
* [How can I remember what I have learned?]({{ '/introduction/1.1.qa/#q16' | relative_url }})
* [What are some common stereotypes, biases, and misunderstandings about computer science?]({{ '/introduction/1.1.qa/#q19' | relative_url }})
* [Given how powerful AI has become, is learning computer science still worth it?]({{ '/introduction/1.1.qa/#q20' | relative_url }})
* [Should I learn AI first, or traditional computer science first?]({{ '/introduction/1.1.qa/#q21' | relative_url }})
* [Can I use AI tools while learning? Will using AI heavily prevent me from mastering the material?]({{ '/introduction/1.1.qa/#q22' | relative_url }})

You can read this [History of Computing]({{ '/introduction/1.2.history' | relative_url }}) to gain the background understanding needed for further study.
...
| No. | Title | Type |
|---|---|---|
| 6.1 | [Computer Graphics and Visual Computing]({{ '/applied/6.1.computer-graphics-and-visual-computing/' | relative_url }}) | Applied |
| 6.2 | [Human-Computer Interaction and Design]({{ '/applied/6.2.human-computer-interaction-and-design/' | relative_url }}) | Applied |
| 6.3 | [Data Engineering and Data Science]({{ '/applied/6.3.data-engineering-and-data-science/' | relative_url }}) | Applied |
| 6.4 | [Robotics and Autonomous Systems]({{ '/applied/6.4.robotics-and-autonomous-systems/' | relative_url }}) | Applied |
| 6.5 | [Scientific Computing and Simulation]({{ '/applied/6.5.scientific-computing-and-simulation/' | relative_url }}) | Applied |
| 6.6 | [Quantum Computing]({{ '/applied/6.6.quantum-computing/' | relative_url }}) | Advanced |
| 6.7 | [Web and Application Development]({{ '/applied/6.7.web-and-application-development/' | relative_url }}) | Applied |
...
* [认真学习计算机科学需要多久？]({{ '/introduction/1.1.qa/#q5' | relative_url }})
* [这份指南是什么，适合谁？]({{ '/introduction/1.1.qa/#q6' | relative_url }})
* [计算机科学都包含哪些内容？]({{ '/introduction/1.1.qa/#q9' | relative_url }})
* [编程和计算机科学是什么关系？]({{ '/introduction/1.1.qa/#q10' | relative_url }})
* [计算机科学的知识保质期有多久？]({{ '/introduction/1.1.qa/#q12' | relative_url }})
* [学习计算机科学真的很难吗？]({{ '/introduction/1.1.qa/#q14' | relative_url }})
* [怎样才能记住所学内容？]({{ '/introduction/1.1.qa/#q16' | relative_url }})
* [针对计算机科学的常见刻板偏见、误解有哪些？]({{ '/introduction/1.1.qa/#q19' | relative_url }})
* [既然 AI 已经这么强，学习计算机科学还值得吗？]({{ '/introduction/1.1.qa/#q20' | relative_url }})
* [我应该先学 AI，还是先学传统计算机科学？]({{ '/introduction/1.1.qa/#q21' | relative_url }})
* [学习时可以用 AI 工具吗？大量使用 AI 是否会妨碍掌握知识？]({{ '/introduction/1.1.qa/#q22' | relative_url }})

为了给进一步的学习提供理解，你可以阅读这份“[计算机发展史]({{ '/introduction/1.2.history' | relative_url }})”。
...
| 序号 | 标题 | 定位 |
|---|---|---|
| 6.1 | [计算机图形学与视觉计算]({{ '/applied/6.1.computer-graphics-and-visual-computing/' | relative_url }}) | 应用 |
| 6.2 | [人机交互与设计]({{ '/applied/6.2.human-computer-interaction-and-design/' | relative_url }}) | 应用 |
| 6.3 | [数据工程与数据科学]({{ '/applied/6.3.data-engineering-and-data-science/' | relative_url }}) | 应用 |
| 6.4 | [机器人与自主系统]({{ '/applied/6.4.robotics-and-autonomous-systems/' | relative_url }}) | 应用 |
| 6.5 | [科学计算与仿真]({{ '/applied/6.5.scientific-computing-and-simulation/' | relative_url }}) | 应用 |
| 6.6 | [量子计算]({{ '/applied/6.6.quantum-computing/' | relative_url }}) | 进阶 |
| 6.7 | [Web 与应用开发]({{ '/applied/6.7.web-and-application-development/' | relative_url }}) | 应用 |
...
| 序号 | 标题 | 定位 |
|---|---|---|
| 9.1 | [计算机科学与数学：债务、差异与对话]({{ '/interdisciplinary/9.1.cs-and-mathematics-debt-difference-and-dialogue/' | relative_url }}) | 跨界 |
| 9.2 | [计算机科学与物理：信息、熵与计算]({{ '/interdisciplinary/9.2.cs-and-physics-information-entropy-and-computation/' | relative_url }}) | 跨界 |
| 9.3 | [计算机科学、认知科学与神经科学：智能、表征、具身]({{ '/interdisciplinary/9.3.cs-cognitive-science-and-neuroscience-intelligence-representation-embodiment/' | relative_url }}) | 跨界 |
| 9.4 | [计算机科学与语言学：语言、语法与计算]({{ '/interdisciplinary/9.4.cs-and-linguistics-language-grammar-and-computation/' | relative_url }}) | 跨界 |
| 9.5 | [计算机科学与经济学：机制设计与算法博弈论]({{ '/interdisciplinary/9.5.cs-and-economics-mechanism-design-and-algorithmic-game-theory/' | relative_url }}) | 跨界 |
| 9.6 | [计算机科学、法律与政策：隐私、知识产权与算法问责]({{ '/interdisciplinary/9.6.cs-law-and-policy-privacy-ip-and-algorithmic-accountability/' | relative_url }}) | 跨界 |
