...
审查的技术侧，是带着具体问题阅读改动：它是否正确，包括边界情况？它是否做了自己声称要做的事？它是否清楚且结构良好？它是否符合代码库的约定和架构？它是否引入安全问题、性能问题或技术债务？有没有测试？测试是否覆盖重要情况？审查者既作为批评者，也作为未来维护者阅读改动，寻找将来会造成问题的地方。有效审查需要 §8.3 的阅读能力——在周围代码语境中理解改动——也需要 §8.4 的代码技艺标准——识别什么让代码好或坏。
